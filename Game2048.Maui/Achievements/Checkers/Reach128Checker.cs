...
public class Reach128Checker : ISessionAchievementChecker
{
    public AchievementType Type => AchievementType.Reach128;

    public bool Check(StateSnapshot state, List<TileTransition> transitions)
    {
        return state.TileSnapshots.Any(t => t.Value == 128);
    }
}
